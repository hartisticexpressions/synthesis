...
namespace SynthesisCore.UI
{
    public class GeneralPage
    {
        ...
        {
            AnalyticsToggle = new ToggleItem("Analytics",
                new Toggle("analytics"));
            
            UnitsDropdown = new DropdownItem("Measurement Units",
                new Dropdown("measurement-units", 0, "Metric", "Imperial"));
            
            QualityDropdown = new DropdownItem("Quality",
                new Dropdown("quality", 0, "Low", "Medium", "High"));
            
            ResolutionDropdown = new DropdownItem("Screen Resolution",
